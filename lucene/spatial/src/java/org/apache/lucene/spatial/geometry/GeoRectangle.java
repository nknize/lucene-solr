...
public class GeoRectangle extends GeoShape {
  ...
  GeoRectangle(final double minLat, final double maxLat, final double minLon, final double maxLon) {
    super();
    this.minLat = minLat;
    this.maxLat = maxLat;
    this.minLon = minLon;
  ...
  protected Point computeCenter() {
    ...
    final double cntrY = getHeight() / 2 + minLat;
    double cntrX = getWidth() / 2 + minLon;
  ...
  public boolean equals(Object o) {
    ...
    GeoRectangle rectangle = (GeoRectangle) o;
    ...
    return Double.compare(rectangle.minLon, minLon) == 0;
